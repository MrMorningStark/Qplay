const HeroBanner = (props) => {
    return <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" data-pause="hover" data-interval="2000">
        ...
        <div className="carousel-inner">
            {props.rail.OttAsset.map((asset, index) => {
                return <div className={index===0?"carousel-item active":"carousel-item"}>
                    <img src={asset.LandscapeImageUrl} className="d-block  round-img" alt="First slide" />
                    <br />
                    <br />
                </div>
            })}
